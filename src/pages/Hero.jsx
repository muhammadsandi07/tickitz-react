...
const Hero = () => {
  ...
  return (
    <>
      <div>
        <section className='flex max-md:flex-col   items-center py-[51px] '>
          <div className='flex flex-col gap-5'>
            ...
            <p className='max-md:text-center max-md:mb-[19px] text-light-text leading-8 tracking-[0.75px] '>
        ...
        <section className='choose-us'>
          ...
          <h2 className=' max-sm:text-center text-[32px] text-[#121212] mt-[14px] mb-[24px]'>
            Unleashing the Ultimate Movie Experience
          </h2>
          <div className='flex max-sm:flex-col gap-8'>
            <div className='flex flex-col gap-[17px] max-sm:items-center max-sm:justify-center '>
